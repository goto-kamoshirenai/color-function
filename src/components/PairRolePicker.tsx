...
export function PairRolePicker() {
  ...
  return (
    <section
      ...
      className="border-border-strong bg-surface sm:rounded-panel sticky top-0 z-20 -mx-4 mb-4 border-b px-4 py-2.5 sm:top-8 sm:mx-0 sm:mt-3 sm:border sm:px-4 sm:py-3 xl:fixed xl:top-[64px] xl:left-5 xl:m-0 xl:w-[168px] xl:border xl:px-3 xl:py-3"
    >
