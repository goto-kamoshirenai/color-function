...
| **iconoir-react**                              | アイコン                              | 軽量・一貫したストロークアイコン。アプリ内アイコンはこれに統一（テーマ/共有/削除/追加/ヘルプ/合否/入替/アクセント指定等）                                                                                                                                                                             |
...
| ツール                         | 用途                                     | 備考                                                                                                  |
| ------------------------------ | ---------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| ~~Framer Motion (motion)~~     | → **採用済み**（スプラッシュ実装で導入） | フェーズ序列・スキップ中断・exit フェードを安定化。`MotionGlobalConfig.skipAnimations` でテスト安定化 |
